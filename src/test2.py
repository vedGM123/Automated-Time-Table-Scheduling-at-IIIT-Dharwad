...
def find_suitable_room_for_slot(course_code, room_type, day, slot_indices, room_schedule, 
    ...
    # *** MODIFIED FIX ***
    # Use the full course code (e.g., "B1-CS366") as the key
    ...
    for room in pool:
        ...
        # Check if this NEW room is free at the required slots
        if all(si not in room_schedule[room][day] for si in slot_indices):
            # If free, map it and return it
...
def find_consecutive_slots_for_minutes(timetable, day, start_idx, required_minutes,
    ...
    # MODIFIED: This strict constraint has been removed to improve scheduling success.
            ...
            for section in range(num_sections):
                ...
                for _, course in elective_courses_in_section.iterrows():
                    ...
                    for day, slot_indices, comp_type in basket_schedule:
                        ...
                        # *** MODIFIED FIX ***
                        # Use the full 'code' (e.g., "B1-CS366") to find the room
                        # This ensures all departments share the same room for the same code
                        ...
                        for si_idx, si in enumerate(slot_indices):
                            ...
                            # (prevents overwriting if another dept already filled it)
